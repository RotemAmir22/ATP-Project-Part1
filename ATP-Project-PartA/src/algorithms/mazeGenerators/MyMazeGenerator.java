...
//    {
//        Position newP;
//        if(point.getRowIndex() + 1 < maze.getRows() && maze.getCellValue(point.getRowIndex() + 1 , point.getColumnIndex()) == 1) // SOUTH
//        {
//            newP = new Position(point.getRowIndex() + 1,point.getColumnIndex());
//            neighbors.add(newP);
//        }
//        if(point.getRowIndex() - 1 >= 0 && maze.getCellValue(point.getRowIndex() - 1 , point.getColumnIndex()) == 1) // NORTH
//        {
//            newP = new Position(point.getRowIndex() - 1,point.getColumnIndex());
//            neighbors.add(newP);
//        }
//        if(point.getColumnIndex() + 1 < maze.getColoums() && maze.getCellValue(point.getRowIndex() , point.getColumnIndex()) + 1 == 1) // EAST
//        {
//            newP = new Position(point.getRowIndex(),point.getColumnIndex() + 1);
//            neighbors.add(newP);
//        }
//        if(point.getColumnIndex() - 1 >= 0 && maze.getCellValue(point.getRowIndex() , point.getColumnIndex()) - 1 == 1) // WEST
//        {
//            newP = new Position(point.getRowIndex(),point.getColumnIndex() - 1);
//            neighbors.add(newP);
//        }
...
//            {
//                setNeighbors(maze, neighbors, predecessor);
//            }
